class CaixaDaLanchonete {
    ...
    calcularValorDaCompra(metodoDePagamento, itens) {
        if (!["dinheiro", "credito", "debito"].includes(metodoDePagamento)) {
            return "Forma de pagamento inválida!"; // para indicar que a forma de pagamento é inválida
        }

        if (itens.length === 0) {
            return "Não há itens no carrinho de compra!"; // Retorna 0 para indicar que não há itens
        }
...
const metodoPagamento = "debito"; // debito ou "dinheiro" ou "credito"
